...
export default function App() {
  ...
  //       </View>
  //       {/* Nút Sign In */}
  //       <MyButton onPress={() => console.log("Sign In")} />
  //       {/* Xử lý quên mật khẩu */}
...
// const MyInput = props => {
//   const [isForcusButton, setIsForcusButton] = useState(false);
//   return (
//     <View style={{ width: '100%', marginBottom: 16 }}>
//       <Text style={styleFormLogin.text}>{props.content}</Text>
//       <TextInput
//         style={[styleFormLogin.input, { borderColor: isForcusButton ? '#F9B62A' : '#EBEAED', }]}
//         onFocus={() => setIsForcusButton(true)}
//         onBlur={() => setIsForcusButton(false)}
//         selectionColor={isForcusButton ? '#F9B62A' : '#EBEAED'}
